      ...
      function (t, e, o) {
        ...
        e.exports = {
          enable: function (t) {
            ...
            if (
              (e ||
                ((e = document.createElementNS(s.svgNS, 'defs')),
                t.svg.appendChild(e)),
      ...
      function (t, e, o) {
        ...
        (n.prototype.init = function (t, e) {
          (this.viewport = t),
            ...
            (this.requestAnimationFrame = r.createRequestAnimationFrame(
          ...
          (n.prototype.processCTM = function () {
            ...
            if (this.options.center) {
              var o =
                  0.5 *
                  (this.options.width -
                    (this.viewBox.width + 2 * this.viewBox.x) * e.a),
                n =
                  0.5 *
                  (this.options.height -
                    (this.viewBox.height + 2 * this.viewBox.y) * e.a);
              (e.e = o), (e.f = n);
            }
            return (
      ...
      function (t, e, o) {
        ...
        (i.prototype.init = function (t, e) {
          ...
          (this.width = n.width),
            ...
            (this.viewport = l(
              a.getOrCreateViewport(this.svg, this.options.viewportSelector),
              {
                svg: this.svg,
                width: this.width,
                height: this.height,
            ...
            if (
              ...
              if (t && t.length)
                for (var e = t.length - 1; 0 <= e; e--)
                  this.eventListeners.hasOwnProperty(t[e]) &&
                    delete this.eventListeners[t[e]];
            }
            ...
            if (this.options.zoomEnabled && 'none' === this.state) {
              ...
              (this.lastMouseWheelEventTime = Date.now()),
                ...
                (e =
                  -0.3 < e && e < 0.3
                    ? e
                    : ((0 < e ? 1 : -1) * Math.log(Math.abs(e) + 10)) / n);
          ...
          (i.prototype.zoom = function (t, e) {
            this.zoomAtPoint(
              t,
              a.getSvgCenterPoint(this.svg, this.width, this.height),
              e,
            );
          }),
          ...
          (i.prototype.handleDblClick = function (t) {
            ...
            if (
              ...
              -1 <
                (t.target.getAttribute('class') || '').indexOf(
                ...
                (this.publicInstance = this.pi =
                  {
                    ...
                    setBeforePan: function (t) {
                      return (
                        (o.options.beforePan =
                          null === t ? null : r.proxy(t, o.publicInstance)),
                        o.pi
                      );
                    },
                    setOnPan: function (t) {
                    ...
                    zoomIn: function () {
                      return (
                        this.zoomBy(1 + o.options.zoomScaleSensitivity), o.pi
                      );
                    },
                    zoomOut: function () {
                      return (
                        this.zoomBy(1 / (1 + o.options.zoomScaleSensitivity)),
                        o.pi
                      );
                    },
                    getZoom: function () {
        ...
        e.exports = function (t, e) {
          ...
          return (
            c.push({ svg: o, instance: new i(o, e) }),
        ...
        document.documentMode && (s = 'ie'),
          (e.exports = {
              ...
              if (!o) {
                ...
                if (s && 0 < s.length)
                  for (var r = s.length; 0 < r; r--)
                    'defs' !== s[s.length - r].nodeName &&
                      o.appendChild(s[s.length - r]);
                t.appendChild(o);
              }
              var a = [];
              return (
                o.getAttribute('class') &&
                  (a = o.getAttribute('class').split(' ')),
                ~a.indexOf('svg-pan-zoom_viewport') ||
                  (a.push('svg-pan-zoom_viewport'),
            ...
            refreshDefsGlobal: l.throttle(
              function () {
                for (
                  var t = document.querySelectorAll('defs'),
                    e = t.length,
                    o = 0;
                  o < e;
                  o++
    ...
    6: [
      function (t, e, o) {
        function s(t, o) {
          ...
          return h.push({ element: t, fn: e }), e;
        }
        function n(t, e, o, n) {
          var i;
          (i = 'wheel' === l ? o : s(t, o)), t[r](u + e, i, n ? c : p);
        }
        function i(t, e, o, n) {
          var i;
          (i =
            'wheel' === l
              ...
              : (function (t) {
                  for (var e = 0; e < h.length; e++)
                    if (h[e].element === t) return h[e].fn;
                  return function () {};
                })(t)),
            t[a](u + e, i, n ? c : p),
            (function (t) {
              for (var e = 0; e < h.length; e++)
                if (h[e].element === t) return h.splice(e, 1);
            })(t);
        }
        var r, a, l, u, h, c, p;
        e.exports =
          ((h = []),
          (p = { passive: !(c = { passive: !(u = '') }) }),
          window.addEventListener
            ? ((r = 'addEventListener'), (a = 'removeEventListener'))
            : ((r = 'attachEvent'), (a = 'detachEvent'), (u = 'on')),
          (l =
              ...
              : 'DOMMouseScroll'),
          {
            on: function (t, e, o) {
              n(t, l, e, o),
                'DOMMouseScroll' == l && n(t, 'MozMousePixelScroll', e, o);
            },
            off: function (t, e, o) {
              i(t, l, e, o),
                'DOMMouseScroll' == l && i(t, 'MozMousePixelScroll', e, o);
            },
          });
      },
      {},
        ...
        e.exports = {
          ...
          mouseAndTouchNormalize: function (t, e) {
            if (void 0 === t.clientX || null === t.clientX)
              if (
                ((t.clientX = 0),
                void (t.clientY = 0) !== t.touches && t.touches.length)
              ) {
